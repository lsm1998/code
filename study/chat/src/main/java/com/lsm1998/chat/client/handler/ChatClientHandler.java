package com.lsm1998.chat.client.handler;

import com.lsm1998.chat.protocol.IMMessage;
import com.lsm1998.chat.protocol.IMP;
...
public class ChatClientHandler extends SimpleChannelInboundHandler<IMMessage>
{
    ...
    private boolean sendMsg(IMMessage msg)
    {
        ...
        return !msg.getCmd().equals(IMP.LOGOUT);
    }
    ...
    {
        System.out.println((null == msg.getSender() ? "" : (msg.getSender() + ":")) + removeHtmlTag(msg.getContent()));
    }
